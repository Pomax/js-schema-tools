...
const operations = JSON.parse(`[{"type":"remove","key":"ruleset","stable":false,"value":{"__meta":{"description":"The ruleset to use to score a game.","icon":"📜"},"type":"string","choices":["Cantonese","Chinese Classical","Chinese Classical for Bots"],"default":"Chinese Classical"},"valueHash":"98e5804f04901d5d19c158dc59092c52","fn":"removeRuleset","rollback":"rollbackRuleset"},{"type":"rename","oldKey":"wallhack","newKey":"wallhack2","fn":"renameWallhackWallhack2","rollback":"rollbackWallhackWallhack2"},{"type":"update","key":"nested_property.shape.name.default","oldValue":"alice","newValue":"carol","fn":"updateNestedPropertyShapeNameDefault","rollback":"rollbackNestedPropertyShapeNameDefault"},{"type":"add","key":"wind_rotation.__meta.required","value":true,"fn":"addWindRotationMetaRequired","rollback":"rollbackWindRotationMetaRequired"},{"type":"update","key":"wind_rotation.choices","oldValue":[-1,1],"newValue":[0,1,2,3],"fn":"updateWindRotationChoices","rollback":"rollbackWindRotationChoices"},{"type":"move","oldKey":"movable_nested_property","newKey":"updated_property.shape.test_nested_move","fn":"moveMovableNestedPropertyToUpdatedPropertyShapeTestNestedMove","rollback":"rollbackMovableNestedPropertyToUpdatedPropertyShapeTestNestedMove"}]`);
