...
// Oh, no, we're doing this. And if you use another library that also
// shims an .equals method onto Object, then let's hope it's just as
// smart and at least checks to see if there's an Object.equals already
// loaded.
if (Object.equals === undefined) {
  Object.equals = equals;
} else if (Object.equals !== equals) {
  console.warn(`Could not bind Object.equals(): some earlier bit of code already did.`);
}
