...
export class Model {
   ...
   * @throws
   */
  static load = function (recordName, storePath = undefined) {
    return Models.load(this, recordName, storePath);
  };
  ...
  /**
   * Convert this model from its "schema" definition to a pure
   * data object without any meta data or field descriptors.
   */
  fromSchemaToData() {
    if (!this.__converted) {
      fromSchemaToData(this);
    }
  }
