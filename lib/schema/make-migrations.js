/**
 * Determine the series of operation transforms to turn schema1 into schema2.
 */
export function makeMigration(
  schema1,
  schema2,
  schemaChangeHandler = default_change_handler()
) {
...
const activeKey = ${schemaChangeHandler.activeKey.toString()};
